...
public class ConfigService
{
    ...
    [
        ("TEAMS_NOTIFY_TENANT_ID",      (c, v) => c.TenantId       = v),
        ("TEAMS_NOTIFY_CLIENT_ID",      (c, v) => c.ClientId       = v),
        ("TEAMS_NOTIFY_CLIENT_SECRET",  (c, v) => c.ClientSecret   = v),
        ("TEAMS_NOTIFY_DEFAULT_TEAM",   (c, v) => c.DefaultTeam    = v),
        ("TEAMS_NOTIFY_DEFAULT_CHANNEL",(c, v) => c.DefaultChannel = v),
    ];
    ...
    public virtual string GetConfigFilePath()
    {
        ...
        return Path.Combine(appData, "teams-notify", "config.json");
    }
