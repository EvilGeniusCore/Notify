...
public class SendCommandTests
{
    ...
    public async Task Send_MissingCredentials_WithoutDryRun_ReturnsExitCode5()
    {
        ...
        Environment.SetEnvironmentVariable("NOTIFY_TEAMS_TENANT_ID",     null);
        Environment.SetEnvironmentVariable("NOTIFY_TEAMS_CLIENT_ID",     null);
        Environment.SetEnvironmentVariable("NOTIFY_TEAMS_CLIENT_SECRET", null);
